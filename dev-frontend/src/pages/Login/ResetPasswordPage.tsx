...
const Input = styled.input`padding: 10px 12px; border: 1px solid #E2E8F0; border-radius: 8px; font-size: 0.875rem; color: #0F172A; &:focus { outline: none; border-color: #14B8A6; box-shadow: 0 0 0 3px rgba(20,184,166,0.15); }`;
const Submit = styled.button`padding: 10px 16px; background: #14B8A6; color: #FFFFFF; border: none; border-radius: 8px; font-size: 0.875rem; font-weight: 700; cursor: pointer; &:hover:not(:disabled) { background: #0D9488; } &:disabled { background: #CBD5E1; cursor: not-allowed; }`;
const BackLink = styled(Link)`text-align: center; font-size: 0.8125rem; color: #0D9488; text-decoration: none; &:hover { text-decoration: underline; }`;
const ErrorBox = styled.div`padding: 10px 12px; background: #FEF2F2; border: 1px solid #FECACA; border-radius: 8px; font-size: 0.8125rem; color: #B91C1C;`;
const SuccessBox = styled.div`padding: 16px; background: #F0FDFA; border: 1px solid #99F6E4; border-radius: 10px; font-size: 0.875rem; color: #0F766E; line-height: 1.6;`;
