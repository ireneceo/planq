  ...
  return (
    ...
    >
      {loading ? (
        ...
        <ListView projects={enriched} formatDate={formatDate} t={t} onOpen={(id) => navigate(`/talk?project=${id}`)} />
      ) : view === 'timeline' ? (
        <TimelineView projects={enriched} todayStr={todayStr} t={t} onOpen={(id) => navigate(`/talk?project=${id}`)} />
      ) : (
