...
const SearchInput = styled.input`flex:1;border:none;background:transparent;font-size:0.8125rem;color:#334155;&:focus{outline:none;}&::placeholder{color:#94A3B8;}`;
...
const ResultName = styled.span`flex:1;font-size:0.8125rem;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;`;
const NoResults = styled.div`font-size:0.75rem;color:#94A3B8;padding:12px 4px;text-align:center;`;
...
const PName = styled.button`flex:1;text-align:left;border:none;background:none;padding:0;font-family:inherit;font-size:0.8125rem;font-weight:700;color:#0F172A;line-height:1.4;cursor:pointer;overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;&:hover{color:#0F766E;}&:focus-visible{outline:2px solid #14B8A6;outline-offset:2px;}`;
const Unlink = styled.button`flex-shrink:0;width:22px;height:22px;border:none;background:transparent;border-radius:6px;font-size:1.0625rem;line-height:1;color:#CBD5E1;cursor:pointer;&:hover{background:#FEE2E2;color:#B91C1C;}&:disabled{opacity:.5;cursor:default;}`;
const RelLabel = styled.span`font-size:0.6875rem;font-weight:600;color:#0F766E;background:#CCFBF1;border-radius:999px;padding:2px 8px;align-self:flex-start;`;
...
const Pct = styled.span`font-size:0.75rem;font-weight:700;color:#0F172A;font-variant-numeric:tabular-nums;`;
const HealthBadge = styled.span`font-size:0.625rem;font-weight:700;border-radius:999px;padding:2px 8px;`;
const OverdueChip = styled.span`font-size:0.625rem;font-weight:700;color:#B91C1C;background:#FEE2E2;border-radius:999px;padding:2px 8px;`;
const DDay = styled.span`margin-left:auto;font-size:0.6875rem;font-weight:700;color:#64748B;`;
