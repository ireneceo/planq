...
export const TaskTitle = styled.span<{$done?:boolean}>`font-size:0.875rem;font-weight:500;color:#0F172A;cursor:text;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;flex:1 1 auto;min-width:96px;${p=>p.$done&&'text-decoration:line-through;color:#94A3B8;'}&:hover{color:#0F766E;}`;
export const TitleInput = styled.input`flex:1;font-size:0.875rem;font-weight:500;color:#0F172A;border:1px solid #14B8A6;background:#F0FDFA;padding:2px 8px;border-radius:6px;font-family:inherit;height:24px;box-sizing:border-box;&:focus{outline:none;box-shadow:0 0 0 2px rgba(20,184,166,0.15);}`;
export const DelayBadge = styled.span`padding:1px 6px;font-size:0.5625rem;font-weight:700;color:#DC2626;background:#FEF2F2;border:1px solid #FECACA;border-radius:4px;flex-shrink:0;white-space:nowrap;`;
...
export const NameChip = styled.span<{$type:'from'|'to'|'observer'}>`
  display:inline-flex;align-items:center;padding:1px 8px;font-size:0.625rem;font-weight:700;border-radius:8px;white-space:nowrap;flex-shrink:0;
...
`;
export const GroupMenuHint = styled.div`padding:4px 10px 2px;font-size:0.625rem;color:#94A3B8;`;
...
export const GroupTitle = styled.span<{$editable?:boolean}>`font-size:0.8125rem;font-weight:700;color:#0F172A;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:240px;${p=>p.$editable&&'cursor:text;&:hover{color:#0F766E;}'}`;
export const GroupTitleInput = styled.input`font-size:0.8125rem;font-weight:700;color:#0F172A;border:1px solid #14B8A6;background:#F0FDFA;padding:2px 8px;border-radius:6px;font-family:inherit;height:26px;box-sizing:border-box;min-width:160px;flex:0 1 240px;&:focus{outline:none;box-shadow:0 0 0 2px rgba(20,184,166,0.15);}&::placeholder{color:#94A3B8;font-weight:500;}`;
export const GroupCount = styled.span`display:inline-flex;align-items:center;justify-content:center;min-width:20px;height:18px;padding:0 6px;background:#E2E8F0;color:#475569;border-radius:999px;font-size:0.625rem;font-weight:700;flex-shrink:0;`;
...
export const GroupPct = styled.span`font-size:0.6875rem;font-weight:700;color:#64748B;font-variant-numeric:tabular-nums;flex-shrink:0;min-width:30px;`;
...
export const GroupEmpty = styled.div`padding:10px 16px 10px 40px;font-size:0.75rem;color:#CBD5E1;min-width:520px;@media(max-width:640px){min-width:0;}`;
export const AddGroupBtn = styled.button`display:inline-flex;align-items:center;gap:6px;margin:10px 0 4px 12px;padding:7px 12px;background:transparent;color:#0F766E;border:1px dashed #99F6E4;border-radius:8px;font-size:0.75rem;font-weight:600;cursor:pointer;font-family:inherit;&:hover{background:#F0FDFA;border-color:#14B8A6;}`;
...
export const AddTaskInGroupInput = styled.input`flex:0 1 360px;font-size:0.8125rem;color:#0F172A;border:1px solid #14B8A6;background:#F0FDFA;padding:5px 10px;border-radius:6px;font-family:inherit;height:30px;box-sizing:border-box;&:focus{outline:none;box-shadow:0 0 0 2px rgba(20,184,166,0.15);}&::placeholder{color:#94A3B8;}`;
export const AddTaskInGroupGo = styled.button`height:30px;padding:0 14px;background:#14B8A6;color:#FFF;border:none;border-radius:6px;font-size:0.75rem;font-weight:700;cursor:pointer;font-family:inherit;&:hover:not(:disabled){background:#0D9488;}&:disabled{opacity:0.5;cursor:not-allowed;}`;
export const StatusPill = styled.span<{$bg:string;$fg:string;$clickable?:boolean}>`
  padding:2px 8px;background:${p=>p.$bg};color:${p=>p.$fg};font-size:0.625rem;font-weight:600;
...
export const SliderPct = styled.span`font-size:0.75rem;font-weight:700;color:#475569;min-width:32px;text-align:right;`;
export const DateTrigger = styled.button<{$color?:string;$empty?:boolean}>`
  width:100%;padding:4px 6px;font-size:0.75rem;font-weight:600;background:transparent;border:1px solid transparent;border-radius:6px;cursor:pointer;white-space:nowrap;font-family:inherit;text-align:center;
...
`;
export const AssigneeLabel = styled.span`display:inline-block;font-size:0.75rem;color:#0F172A;cursor:pointer;padding:2px 6px;border-radius:4px;&:hover{background:#F1F5F9;}`;
...
export const AssigneeOpt = styled.button<{$active?:boolean}>`display:block;width:100%;padding:5px 10px;font-size:0.75rem;text-align:left;border:none;border-radius:6px;cursor:pointer;background:${p=>p.$active?'#F0FDFA':'transparent'};color:${p=>p.$active?'#0F766E':'#0F172A'};font-weight:${p=>p.$active?600:500};&:hover{background:#F0FDFA;color:#0F766E;}`;
export const AssigneeOptInner = styled.span`display:inline-flex;align-items:center;gap:8px;`;
export const EmptyMsg = styled.div`padding:32px;text-align:center;color:#94A3B8;font-size:0.8125rem;`;
export const DescText = styled.span`font-size:0.75rem;color:#64748B;line-height:1.4;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;`;
