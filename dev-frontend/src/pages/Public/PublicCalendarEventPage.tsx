...
const TimeBox = styled.div`font-size: 0.9375rem; font-weight: 600; color: #0F172A; padding: 12px 16px; background: #F0FDFA; border-radius: 10px; margin-bottom: 20px;`;
...
const DescBox = styled.div`font-size: 0.8125rem; color: #334155; line-height: 1.6; padding: 12px 14px; background: #F8FAFC; border-radius: 8px; white-space: pre-wrap;`;
...
const V = styled.div`font-size: 0.8125rem; color: #0F172A; word-break: break-all;`;
