...
const UnitName = styled.h3`font-size: 1.0625rem; font-weight: 800; color: #0F172A; margin: 0; min-width: 0; word-break: break-word;`;
...
const Footer = styled.div`margin-top: 24px; padding-top: 16px; border-top: 1px solid #F1F5F9; font-size: 0.6875rem; color: #94A3B8; text-align: center;`;
