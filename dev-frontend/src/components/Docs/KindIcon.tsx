// 문서 종류별 라인 아이콘 (Lucide-style). 이모지 사용 안 함.
import React from 'react';
import type { DocKind } from '../../services/docs';

interface Props { kind: DocKind; size?: number; }

const KindIcon: React.FC<Props> = ({ kind, size = 16 }) => {
  const props = {
  ...
  switch (kind) {
    ...
    case 'proposal':
    case 'sow':
      // bar chart in document
      return <svg {...props}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="17" x2="9" y2="13"/><line x1="12" y1="17" x2="12" y2="11"/><line x1="15" y1="17" x2="15" y2="14"/></svg>;
    case 'meeting_note':
      // file with users
      return <svg {...props}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><circle cx="9" cy="14" r="1.5"/><circle cx="14" cy="14" r="1.5"/><path d="M7 18c.5-1.5 1.5-2 2.5-2"/><path d="M16.5 18c-.5-1.5-1.5-2-2.5-2"/></svg>;
    case 'sop':
      // settings
