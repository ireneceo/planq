...
`;
export const HeaderTitle = styled.h3` margin: 0; font-size: 0.875rem; font-weight: 700; color: #0F172A; `;
export const HeaderAction = styled.button`
  background: transparent; border: none; cursor: pointer;
  font-size: 0.75rem; font-weight: 500; color: #14B8A6; padding: 4px 8px; border-radius: 6px;
  &:hover { background: #F0FDFA; }
`;
export const List = styled.div` flex: 1; overflow-y: auto; padding: 4px; `;
export const Loading = styled.div` padding: 40px 16px; text-align: center; color: #94A3B8; font-size: 0.8125rem; `;
export const Empty = styled.div`
  padding: 40px 16px; text-align: center;
  display: flex; flex-direction: column; align-items: center; gap: 8px;
`;
export const EmptyIcon = styled.svg` width: 36px; height: 36px; color: #CBD5E1; `;
export const EmptyTitle = styled.div` font-size: 0.8125rem; font-weight: 600; color: #334155; `;
export const EmptyHint = styled.div` font-size: 0.75rem; color: #94A3B8; line-height: 1.5; `;
...
export const ItemDesc = styled.div`
  ...
  -webkit-line-clamp: 2; -webkit-box-orient: vertical;
`;
export const ItemMeta = styled.div` font-size: 0.6875rem; color: #94A3B8; margin-top: 2px; `;
