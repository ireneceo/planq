...
const NavBtn = styled.button`width:28px;height:28px;border:1px solid #E2E8F0;background:#fff;border-radius:6px;font-size:1rem;color:#475569;cursor:pointer;&:hover{background:#F0FDFA;border-color:#99F6E4;color:#0F766E;}`;
const PLabel = styled.span`font-size:0.8125rem;font-weight:700;color:#0F172A;min-width:120px;text-align:center;`;
const Spacer = styled.div`flex:1;`;
const StatusChip = styled.span<{ $on: boolean }>`font-size:0.75rem;font-weight:700;padding:3px 10px;border-radius:999px;background:${(p) => (p.$on ? '#14B8A6' : '#E2E8F0')};color:${(p) => (p.$on ? '#fff' : '#475569')};`;
const AskText = styled.span`
  font-size: 0.75rem; color: #B45309; line-height: 1.35; margin-right: 2px;
`;
const Head = styled.div`display:flex;flex-direction:column;gap:4px;padding-bottom:10px;border-bottom:1px solid #F1F5F9;`;
const HName = styled.h2`font-size:1.125rem;font-weight:700;color:#0F172A;margin:0;display:flex;align-items:center;gap:8px;`;
...
const OneLine = styled.div`display:flex;gap:14px;flex-wrap:wrap;font-size:0.75rem;color:#64748B;font-weight:600;`;
const Section = styled.div`background:#fff;border:1px solid #E2E8F0;border-radius:12px;padding:14px 16px;`;
const SecTitle = styled.div`font-size:0.8125rem;font-weight:700;color:#0F172A;margin-bottom:8px;display:flex;align-items:center;gap:8px;`;
const Lock = styled.span`font-size:0.625rem;font-weight:600;color:#A16207;background:#FEF9C3;border-radius:999px;padding:2px 8px;`;
...
const GenErr = styled.div`font-size:0.75rem;color:#EF4444;margin-bottom:8px;`;
const Area = styled.textarea`width:100%;min-height:80px;resize:vertical;border:1px solid #E2E8F0;border-radius:10px;padding:10px 12px;font-size:0.8125rem;line-height:1.6;color:#334155;font-family:inherit;&:focus{outline:none;border-color:#14B8A6;box-shadow:0 0 0 3px rgba(20,184,166,.15);}&::placeholder{color:#94A3B8;}`;
const Read = styled.div`font-size:0.8125rem;line-height:1.6;color:#334155;white-space:pre-wrap;`;
...
const Err = styled.div`display:flex;flex-direction:column;align-items:center;gap:10px;padding:40px;color:#92400E;font-size:0.875rem;`;
