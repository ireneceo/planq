...
const PeriodText = styled.span`font-size:0.875rem;font-weight:700;color:#0F172A;min-width:104px;text-align:center;`;
const ThisBtn = styled.button`height:30px;padding:0 12px;border:1px solid #E2E8F0;background:#fff;border-radius:8px;font-size:0.75rem;font-weight:600;color:#475569;cursor:pointer;&:hover{background:#F0FDFA;border-color:#99F6E4;color:#0F766E;}`;
...
const RowSub = styled.span`margin-left:8px;font-size:0.6875rem;font-weight:700;color:#475569;background:#E2E8F0;border-radius:999px;padding:1px 8px;`;
...
const UStatus = styled.span<{ $on: boolean }>`font-size:0.6875rem;font-weight:700;border-radius:999px;padding:2px 9px;background:${(p) => (p.$on ? '#CCFBF1' : '#FEF9C3')};color:${(p) => (p.$on ? '#0F766E' : '#A16207')};`;
