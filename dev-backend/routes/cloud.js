...
// Business 는 콜백(cloud_oauth)·저장위치(cloud_root_folder) 쪽에서만 쓴다.
...
// 저장 위치(루트 폴더) 지정은 routes/cloud_root_folder.js 로 분리했다 — 경로는 그대로다.
router.use(require('./cloud_root_folder'));
