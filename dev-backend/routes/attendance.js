    ...
    try {
      ...
      for (const m of managers) {
        ...
        await notify({
          ...
          // ★ 2026-09-21 — 팀 현황·승인은 #208 에 설정 > 근태 관리로 옮겨졌다. 옛 `/attendance?tab=team` 은
          //   그 탭이 없어 **흰 화면**이었다(Irene: "알림 받았는데 누르면 페이지가 흰페이지 나와").
          link: `/business/settings/attendance?date=${ymd(day.work_date)}`,
