...
const ARTICLES = [
  ...
  { cat: 'attendance', slug: 'request-leave', visibility: 'authenticated', linked_route: '/attendance', est: 2,
    ...
    body: [
      s('좌측 “근태” > 휴가 탭에서 “휴가 신청”을 누릅니다.', 'Open Attendance from the left menu, go to the Leave tab, and press “Request leave”.'),
      ...
      s('관리자가 설정 > 근태 관리에서 승인하거나 반려합니다.', 'An admin approves or rejects it in Settings > Attendance.'),
