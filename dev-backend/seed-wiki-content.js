...
const ARTICLES = [
  ...
  { cat: 'qfile', slug: 'file-trash-restore', visibility: 'authenticated', linked_route: '/files', est: 2,
    ...
    summary: t('삭제한 파일은 휴지통에 30일 보관되고 되돌릴 수 있습니다', 'Deleted files stay in the trash for 30 days and can be restored'),
    body: [
      ...
      note('휴지통의 파일은 30일이 지나면 자동으로 비워집니다. 목록에는 **되돌릴 수 있는 파일만** 보입니다.',
        'Trashed files are cleared automatically after 30 days. Only files that can still be restored are listed.'),
