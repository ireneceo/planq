...
ClientSubscription.init({
  ...
  // 청구 주기
  interval: { type: DataTypes.ENUM('weekly', 'monthly', 'quarterly', 'yearly'), allowNull: false, defaultValue: 'monthly' },
  ...
  status: { type: DataTypes.ENUM('active', 'paused', 'canceled'), allowNull: false, defaultValue: 'active' },
