...
const GATED = [
  ['src/pages/Settings/PlanSettings.tsx', 2, '플랜 CTA + CheckoutModal'],
...
const invoicePage = read(path.join(FE, 'src/pages/Public/PublicInvoicePage.tsx'))
  || read(path.join(FE, 'src/pages/PublicInvoicePage.tsx'));
if (invoicePage && /canPurchaseInApp/.test(invoicePage)) {
...
const loginPage = read(path.join(FE, 'src/pages/Auth/LoginPage.tsx')) || read(path.join(FE, 'src/pages/LoginPage.tsx'));
