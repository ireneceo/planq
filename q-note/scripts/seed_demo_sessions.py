...
def build_sessions(user_name):
    return [
        {
            'title': '노들커머스 브랜드 리뉴얼 킥오프',
            'days_ago': 3,
            'duration': 2520,  # 42분
            'participants': f'{user_name}, 이지민, 정민아(노들커머스)',
            ...
            'summary': (
                '노들커머스 브랜드 리뉴얼 킥오프 회의. 고객사는 다음 주 화요일 임원 보고를 앞두고 있어 '
                '금요일 오전까지 로고 시안 3종과 컬러 시스템 제안서를 함께 받기를 요청했다. '
                '온무늬는 기존 로고 원본 파일 전달을 요청했고, 고객사가 자료실 업로드로 처리했다. '
        ...
        },
        {
            ...
            'key_points': (
                '· 이번 주 최우선은 노들커머스 시안 금요일 납품\n'
                '· 로고 시안 3종 중 2종 완료, 나머지 1종은 금일 마감\n'
                '· 모눈스터디 랜딩 성능 점검 결과는 내일 오전 공유\n'
                '· 들녘테이블 청구서 금일 발송'
            ),
            'summary': (
                '주간 팀 미팅. 이번 주 최우선 과제는 노들커머스 로고 시안 금요일 납품으로 확인했다. '
                '디자인은 3종 중 2종을 마쳤고 남은 1종은 당일 마감 예정이다. '
                '개발은 모눈스터디 랜딩 성능 점검을 진행 중이며 결과는 다음 날 오전 공유하기로 했다. '
                '들녘테이블 청구서는 당일 발송하기로 정리했다.'
            ),
            'utterances': [
                ('김서연', '이번 주 우선순위부터 맞추겠습니다. 노들커머스 시안 금요일 납품이 최우선입니다.', 0, 0.0),
                ('이지민', '로고 시안은 3종 중 2종 끝났고 남은 하나는 오늘 마무리하겠습니다.', 0, 18.7),
                ('박준호', '모눈스터디 랜딩 성능 점검은 측정까지 끝났고 개선안 정리만 남았습니다.', 0, 36.1),
                ('김서연', '결과는 언제쯤 공유 가능할까요?', 1, 49.5),
                ('박준호', '내일 오전에 리포트로 정리해서 올리겠습니다.', 0, 55.8),
                ('김서연', '들녘테이블 청구서는 오늘 발송하겠습니다.', 0, 68.2),
            ],
            'questions': [
                ('결과는 언제쯤 공유 가능할까요?',
                 '모눈스터디 랜딩 성능 점검 리포트는 다음 날 오전 공유 예정입니다. 담당은 박준호입니다.'),
            ],
        },
        {
            'title': '모눈스터디 랜딩 리뉴얼 요구사항 정리',
            'days_ago': 5,
            'duration': 2100,  # 35분
            ...
            'summary': (
                '모눈스터디 앱 랜딩 리뉴얼 요구사항 정리 회의. 랜딩은 Hero, Feature, Pricing, FAQ, CTA '
