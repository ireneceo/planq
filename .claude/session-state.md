...
- **구현 진행(미배포):**
  ...
  - ⏳ **§6-C 그래프** 주별 델타 클린 번다운(carry-in 분리) — daily-progress 주시작 baseline 노출 필요
  - ⏳ **U4** 단조완화(되돌림 ↓마커) — 프론트 SVG, chart 회귀주의
- **검증:** A1·A2 배포 라이브(planq.kr q-task 200). U5 빌드EXIT0·TS0/엔드포인트200·403·401/게이트경계/헬스29/29/패리티811.
