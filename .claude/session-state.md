...
- **미배포 3건:** `394f4d4` Q Mail 임시저장 + `83d52a6` Finance 12개월 추이 + `831b800` Tasks 통계 고급필터(담당자/카테고리/출처). 전부 확정IA 미변경·내용충실화, dev 검증완료(E2E 9/9·4/4·3/3), /배포 대기. (참고: stats tasks 응답 filters_applied 미반환 — 주석 문서화뿐, 기능 무관)
