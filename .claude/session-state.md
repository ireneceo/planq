...
- 🔨 **③ Q Mail 로직/AI (미착수)** — #153 답장언어 · #179 요약무반응(프론트 실패분기) · #164 미리보기주소 · #154 일괄버튼 · **#180 뱃지(⚠️business_id 게이트)**
- 🔨 **④ 기획 (Fable verdict 완료 — Irene 승인 대기)**:
  - **#167**: Fable=반전 권장(개요=읽기전용 대시보드 / 상세=편집, 단일원천 유지). ⚠️#148 되감기. 개인보관함 동일
  - **#166**: Fable=주 40%경과 전 behind 봉인 + 주중 과정형/주말 결과형 문구. spi<0.6 심각은 유예 무시. 임계 0.85 유지
  - **#162**: 피드백 page_url 팝아웃 오기록 버그(=/help-popout 23건 원인) + client_env/is_popout 컬럼(⚠️마이그레이션). 조기착수 권장
- ✅ **이미해결 13건**(v1.47.0) close 대상 · **미확인 2건**(#179 last_error·#164 실물메일)
