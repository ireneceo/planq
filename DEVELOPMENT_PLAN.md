...
> **최종 업데이트:** 2026-07-03 (Opus, 2차) — **C1 q-note STT 실분 과금 (트랙B 과금) + 트랙A 보안 하드닝 — 둘 다 코드완료+검증.** 외부IP :3003/:8000 직결 000(차단) · 헬스 29/29 · 프론트 빌드 EXIT0/TS0. live WS E2E(mock)만 남음.
...
> - **미완(다음 섹션):** live WS E2E(mock, 4030/4031·flush) · 운영 배포(Irene /배포 대기 — 운영 nginx 3002/8001·PLANQ_NODE_BASE_URL :3002 체크). **미푸시분 다수 누적(이전 세션 포함).**
