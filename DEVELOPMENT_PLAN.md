...
> **최종 업데이트:** 2026-06-08 — **v1.33.2 운영 라이브** (deploy `20260608_190800`, commit `2227a01`). N+92(Focus 배너 실시간/Q helper 엔터/미결제 청구 결제 UI) + **설정 메뉴 개인/워크스페이스 분리**(개인 설정에 내 프로필·외부 연동·내 업무 설정 진입로 신설, Q Mail 계정 노출 — 기존엔 메뉴 없어 "찾을 수 없음") + 통합 런처·팝아웃·tap-to-reveal 동봉. 검증: 운영 헬스 내부/외부 OK · PM2 prod 정상 · 빌드 EXIT 0.
>
