...
| 카나리 `maillabel` 신설 (14검사) | 폴더 술어 · i18n 원천(ko·en) · 실화면 · 배지 축 · **폰 가시 단서** · 전후 수 일치 | — | — |
