...
> **최종 업데이트:** 2026-05-11 v1.6.0 (사이클 N+9 — 권한 옵션 A + 개인 보관함 + 이미지 라이트박스 + 공유 미리보기 보강)
>
> **이전 라이브:** 2026-05-11 `eb8769a` (v1.6.0 N+9, 110s) / `2f379ee` (v1.5.5 N+8 hotfix, 125s) / `c962c5f` (v1.5.4 N+8 follow-up, 111s) / `1031409` (v1.5.3 N+6/N+7, 108s) / 2026-05-10 `8dc5251` (v1.5.2 N+5 권한, 109s)
>
> **다음 진입 ★:** (Irene 선택)
>
