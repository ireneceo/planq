...
> **최종 업데이트:** 2026-05-11 v1.5.5 (사이클 N+8 hotfix — 인박스 reviewer 회귀 + Q Talk 채팅방 ⋮ 메뉴 + 멤버 카운트 정합성 + 공유/설문 docs 박제)
>
> **이전 라이브:** 2026-05-11 `2f379ee` (v1.5.5 N+8 hotfix, 125s) / `c962c5f` (v1.5.4 N+8 follow-up, 111s) / `1031409` (v1.5.3 N+6/N+7, 108s) / 2026-05-10 `8dc5251` (v1.5.2 N+5 권한, 109s) / `5cd518e` (v1.5.1 follow-up, 113s)
>
> **다음 진입 ★:** (Irene 선택)
>
