...
> **최종 업데이트:** 2026-07-03 (Opus, 2차) — **C1 STT 실분 과금 완결 + H-f rate-limit + 🚀 운영 배포 완료.** dev: 외부IP직결 000·WS hard-block 5/5·rate-limit 4/4·헬스 29/29. 운영(commit 1bd9e3b): DB 마이그레이션 선행 → 배포 → backend 127.0.0.1:3004 하드닝 라이브·공개 https 200·C1 과금 스모크 4/4. 남은 것: 운영 실녹음 샘플 · 후속 nginx deny(sudo, lua).
