...
> **최종 업데이트:** 2026-05-11 v1.5.4 (사이클 N+8 follow-up — 모바일 채팅 Unread/별표 일관 + AI 라벨 분기 통일 + refresh rolling renewal + 인박스 액션 정리)
>
> **이전 라이브:** 2026-05-11 `c962c5f` (v1.5.4 N+8 follow-up, 111s) / `1031409` (v1.5.3 N+6/N+7, 108s) / 2026-05-10 `8dc5251` (v1.5.2 N+5 권한, 109s) / `5cd518e` (v1.5.1 follow-up, 113s) / `e1ee6e4` (v1.5.0 N+4, 105s)
>
> **다음 진입 ★:** (Irene 선택)
>
